    ...
    <div class="container mt-4">
        <div class="row mb-1 justify-content-left">
                <div class="col-md-3 text-left">
                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRNvb2yR87_JIe7S_iG54piGE55UQjzLXd__aDer1rGDg&s" style="max-width: 100px; max-height: 200px;">
                </div>
                <div class="col-md-6 text-center">
                    <h4>PEMERINTAH KABUPATEN TEMANGGUNG KECAMATAN KEDU</h4>
                    <h4><b>DESA CANDIMULYO</b></h4>
                    <p>Sekretariat : Dusun Sosoran, Desa Candimulyo Kode Pos 56252</p>
