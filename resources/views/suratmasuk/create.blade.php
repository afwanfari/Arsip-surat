    ...
    <div class="card mx-auto max-w-lg">
        ...
        <form action="{{ route('suratmasuk.store') }}" method="POST" enctype="multipart/form-data"
            ...
            <div>
                ...
                <input type="text" class="border border-gray-300 rounded px-4 py-2 w-full" id="pengirim" name="pengirim"
                    required>
            </div>
            <div>
                <label for="perihal" class="block text-gray-700 text-sm font-bold mb-2">Perihal:</label>
                <input type="text" class="border border-gray-300 rounded px-4 py-2 w-full" id="perihal" name="perihal"
                    required>
            </div>
            <div>
                <label for="tanggal" class="block text-gray-700 text-sm font-bold mb-2">Tanggal Surat:</label>
                <input type="date" class="border border-gray-300 rounded px-4 py-2 w-full" id="tanggal" name="tanggal"
                    required>
            </div>
            <div>
